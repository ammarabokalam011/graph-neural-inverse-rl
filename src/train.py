...
def main(args):
    ...
    try:
        dir_name = arg_to_text[
            str(args.cameras) + str(args.attention) + str(args.concat) + str(args.context1) + str(args.context2)]
    ...
    work_dir = os.path.join(args.log_dir, args.domain_name + '_' + args.task_name, args.algorithm, args.exp_suffix,
    ...
    video = VideoRecorder(video_dir if args.save_video else None, height=448, width=448,
                          fps=15 if args.domain_name == 'robot' else 25)
        ...
        if done:
            ...
            if step % args.eval_freq == 0:
                ...
                if test_env is not None:
                    evaluate(test_env, agent, video, state_recorder, args.eval_episodes, L, step, test_env=True,
